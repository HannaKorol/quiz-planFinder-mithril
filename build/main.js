  ...
  var Questionnaire = {
    oninit(vnode) {
      ...
      state.evaluatePlan = (answers) => {
        ...
        if (selectedOptions.includes("For personal use") && selectedOptions.includes("Yes") && selectedOptions.includes("15") && selectedOptions.includes("3") && selectedOptions.includes("More") && selectedOptions.includes("20 GB")) {
          return "Revolutionary";
        } else if (selectedOptions.includes("For personal use") && selectedOptions.includes("Yes") && selectedOptions.includes("30") && selectedOptions.includes("10") && selectedOptions.includes("More") && selectedOptions.includes("500 GB")) {
          return "Legend";
        } else if (selectedOptions.includes("For business purposes") && selectedOptions.includes("Yes") && selectedOptions.includes("15") && selectedOptions.includes("3") && selectedOptions.includes("More") && selectedOptions.includes("50 GB")) {
          return "Essential";
        } else if (selectedOptions.includes("For business purposes") && selectedOptions.includes("Yes") && selectedOptions.includes("30") && selectedOptions.includes("10") && selectedOptions.includes("More") && selectedOptions.includes("500 GB")) {
          return "Advanced";
        } else if (selectedOptions.includes("For business purposes") && selectedOptions.includes("Yes") && selectedOptions.includes("30") && selectedOptions.includes("unlimited") && selectedOptions.includes("More") && selectedOptions.includes("1000 GB")) {
          return "Unlimited";
        } else {
          return "Basic";
        }
